...
#include "FeaturesCalculator_IDEA.C"
...
void allinone_IDEA(
    ...
    if (type == "s1") {
        ...
        inputFile = "./IDEA_card_Bs0Dstaunu-Dsphipi-phiKK_100k_RandomSeed0.root";
        if (noise_ == 10) outputFile = "./features/IDEA_card_DsTauNu_10Noise.root";

    } else if (type == "s2") {
        cout << "Bs->Ds mu nu. " << endl;
        inputFile = "./IDEA_card_Bs0Dsmunu-Dsphipi-phiKK_100k_RandomSeed0.root";
        if (noise_ == 10) outputFile = "./features/IDEA_card_DsMuNu_10Noise.root";

    } else if (type == "s3") {
        cout << "Bs->Ds* tau nu. " << endl;
        inputFile = "./IDEA_card_Bs0Dsstartaunu-Dsphipi-phiKK_30k_RandomSeed0_30k_RandomSeed1.root";
        if (noise_ == 10) {
            outputFile = "./features/IDEA_card_DsstarTauNu_10Noise.root";
            if (abs(alpha - 0) < 1e-6) outputFile = "./features/IDEA_card_DsstarTauNu_10Noise_0Alpha.root";
            if (abs(alpha - 0.1) < 1e-6) outputFile = "./features/IDEA_card_DsstarTauNu_10Noise_01Alpha.root";
            if (abs(alpha - 0.5) < 1e-6) outputFile = "./features/IDEA_card_DsstarTauNu_10Noise_05Alpha.root";
            if (abs(alpha - 2) < 1e-6) outputFile = "./features/IDEA_card_DsstarTauNu_10Noise_2Alpha.root";
        }

    } else if (type == "s4") {
        cout << "Bs->Ds* mu nu. " << endl;
        inputFile = "./IDEA_card_Bs0Dsstarmunu-Dsphipi-phiKK_30k_RandomSeed0.root";
        if (noise_ == 10) {
            outputFile = "./features/IDEA_card_DsstarMuNu_10Noise.root";
            if (abs(alpha - 0) < 1e-6) outputFile = "./features/IDEA_card_DsstarMuNu_10Noise_0Alpha.root";
            if (abs(alpha - 0.1) < 1e-6) outputFile = "./features/IDEA_card_DsstarMuNu_10Noise_01Alpha.root";
            if (abs(alpha - 0.5) < 1e-6) outputFile = "./features/IDEA_card_DsstarMuNu_10Noise_05Alpha.root";
            if (abs(alpha - 2) < 1e-6) outputFile = "./features/IDEA_card_DsstarMuNu_10Noise_2Alpha.root";
        }
    ...
    for (Int_t i_en = 0; i_en < num_test; i_en++) {
        ...
        for (Int_t imu : muCandidates) {
            ...
            GenParticle* piTrackObj = (GenParticle*)piTrack->Particle.GetObject();
            TVector3 v3C(piTrackObj->X, piTrackObj->Y, piTrackObj->Z);
            v3C += v3CNoise;
            // noise for muon
