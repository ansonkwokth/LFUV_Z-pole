...
// === R(Lambda_c) ===
// ===================
// chnaged using IDEA delphes card
...
#include "FeaturesCalculator_IDEA.C"  // customized feature calculation functions
#include "FeaturesClass.C"            // features list
#include "FinalStatesClass.C"         // final states list
#include "Geometry_IDEA.C"            // customized geometric functions
#include "Reconstructor_IDEA.C"       // reconstruction scheme: tagged final states particles and momentum reconstruction related function
#include "Rtypes.h"
...
void allinone_IDEA(
    ...
    if (type == "s1") {
        ...
        inputFile = "./IDEA_card_Lambdab_lambdactaunu_pkpi_allchannel_1m_seed0_new.root";
        if (noise_ == 10) outputFile = "./features/IDEA_card_LambdacTauNu_10Noise.root";

    } else if (type == "s2") {
        cout << "Lambdab->Lambdac mu nu. " << endl;
        inputFile = "./IDEA_card_Lambdab_lambdacmunu_pkpi_allchannel_1m_seed0_new.root";
        if (noise_ == 10) outputFile = "./features/IDEA_card_LambdacMuNu_10Noise.root";
